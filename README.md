...
融合紫微易派（倪师）阳宅互证的方法论。Python 精确排盘，AI 生成有温度的解读，HTML 暗色星空主题可视化输出。
...
输入生辰信息后，天纪紫薇自动排盘并生成可视化命盘。以马斯克的命盘为例：
...
天纪紫薇基于开放的 [Agent Skills](https://agentskills.io) 协议，可在任何 skills-compatible 的 AI agent runtime 中运行。
...
或者用通用 CLI 安装器（[dmych1989/skills](https://github.com/dmych1989/skills)）：
